...
//        }
    ...
    public void setup(Ship owner, String title, float x, float y, float vx, float vy, int damage, float angle, float lifetimeDistance, boolean bfg) {
        getActiveElement().activate(owner, title, x, y, vx, vy, damage, angle, lifetimeDistance, bfg);
    }
